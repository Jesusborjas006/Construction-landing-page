    ...
    <section className="max-w-[1600px] mx-auto p-8 sm:p-10 text-center mb-10">
      ...
      <div className="flex flex-col justify-between md:flex-row gap-8">
        <div className="relative ">
          <div className="absolute text-white z-10 bottom-[45px] w-full space-y-4 px-2">
        ...
        <div className="relative">
          <div className="absolute text-white object-cover z-10  w-full bottom-[100px] space-y-4 px-2">
            <h3 className="font-bold text-2xl">Unleash Your Creativity</h3>
            <p className="text-sm text-white/90">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            </p>
            <button className="text-white/95 border border-white/95 rounded-tl-3xl rounded-tr-md rounded-br-3xl rounded-bl-md py-2 px-8">
              Read More
            </button>
          </div>
          <img
